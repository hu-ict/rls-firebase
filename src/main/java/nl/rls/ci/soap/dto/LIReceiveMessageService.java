...
public class LIReceiveMessageService extends Service {
     ...
     * 
     * @param features
     *     A list of {@link javax.xml.ws.WebServiceFeature} to auth on the proxy.  Supported features not in the <code>features</code> parameter will have their default values.
     * @return
     *     returns UICReceiveMessage
     */
    @WebEndpoint(name = "UICReceiveMessagePort")
