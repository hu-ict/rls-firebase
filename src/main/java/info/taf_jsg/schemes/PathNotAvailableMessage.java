 ...
 *         &lt;element ref="{http://taf-jsg.info/schemes}InterruptionInformation"/>
...
@XmlRootElement(name = "PathNotAvailableMessage")
public class PathNotAvailableMessage {
    ...
    @XmlElement(name = "InterruptionInformation", required = true)
